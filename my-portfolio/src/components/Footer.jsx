  ...
  return (
    <div className="footer-section">
      <div className="container">
        <div className="footer-content">
          <div className="w-full md:w-1/2 lg:w-1/4 pr-10">
            ...
            <p>
              ...
              culpa iusto, ad tempore earum, fugiat sed dignissimos perferendis
              praesentium reiciendis itaque velit quo, quis consequatur
              assumenda consequuntur doloribus nisi aut.
            </p>
          </div>
        ...
        <div className="text-white flex justify-center w-full items-center gap-4 my-10">
